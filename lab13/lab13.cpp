...
int main(){
    ...
    while (startTimeHrs < endTimeHrs || startTimeMin < endTimeMin){ //Loop that will add one minute
        startTimeMin = startTimeMin + 1;
   ...
   while (startHour < endHour){             //Loop will add 15 min intervals
       minutes= minutes + 15;
       if (minutes % 60 == 0){
            minutes = 0;
